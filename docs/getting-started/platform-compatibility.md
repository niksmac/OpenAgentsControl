...
curl -fsSL https://raw.githubusercontent.com/niksmac/OpenAgentsControl/main/install.sh | bash -s core
```
...
# Profile-based installation
curl -fsSL https://raw.githubusercontent.com/niksmac/OpenAgentsControl/main/install.sh | bash -s full
```
...
```powershell
# Download the script
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/niksmac/OpenAgentsControl/main/install.sh" -OutFile "install.sh"
...
```bash
# Clone the repo
git clone https://github.com/niksmac/OpenAgentsControl.git
...
```bash
curl -fsSL https://raw.githubusercontent.com/niksmac/OpenAgentsControl/main/install.sh > install.sh
