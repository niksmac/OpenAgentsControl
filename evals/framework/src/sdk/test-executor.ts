  ...
  async execute(
    ...
    try {
      ...
      const agentDisplayMap: Record<string, string> = {
        ...
        'mobile-design-specialist': 'MobileDesignSpecialist',
        'development/mobile-design-specialist': 'MobileDesignSpecialist',
        'MobileDesignSpecialist': 'MobileDesignSpecialist',
