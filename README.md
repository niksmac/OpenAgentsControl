...
[![GitHub stars](https://img.shields.io/github/stars/niksmac/OpenAgentsControl?style=flat-square&logo=github&labelColor=black&color=ffcb47)](https://github.com/niksmac/OpenAgentsControl/stargazers)
...
[![Last Commit](https://img.shields.io/github/last-commit/niksmac/OpenAgentsControl?style=flat-square&labelColor=black&color=8957e5)](https://github.com/niksmac/OpenAgentsControl/commits/main)

[🚀 Quick Start](#-quick-start) • [💻 Show Me Code](#-example-workflow) • [🗺️ Roadmap](https://github.com/niksmac/OpenAgentsControl/projects) • [💬 Community](https://nextsystems.ai)
...
> **Full comparison:** [Read detailed analysis →](https://github.com/niksmac/OpenAgentsControl/discussions/116)
...
```bash
curl -fsSL https://raw.githubusercontent.com/niksmac/OpenAgentsControl/main/install.sh | bash -s developer
```
...
**Or interactive:**
```bash
curl -fsSL https://raw.githubusercontent.com/niksmac/OpenAgentsControl/main/install.sh -o install.sh
bash install.sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/niksmac/OpenAgentsControl/main/update.sh | bash
```
...
A: Both are built on OpenCode. OAC focuses on **control & repeatability** (approval gates, pattern control, team standards). Oh My OpenCode focuses on **autonomy & speed** (parallel agents, auto-execution). [Read detailed comparison →](https://github.com/niksmac/OpenAgentsControl/discussions/116)
...
Check out our [**Project Board**](https://github.com/niksmac/OpenAgentsControl/projects) to see:
...
- 💡 [**Submit Feature Requests**](https://github.com/niksmac/OpenAgentsControl/issues/new?labels=enhancement)
- 🐛 [**Report Bugs**](https://github.com/niksmac/OpenAgentsControl/issues/new?labels=bug)
- 💬 [**Join Discussions**](https://github.com/niksmac/OpenAgentsControl/discussions)
